# M16 – Power-Law Model (n = 5)

## Description

This model is part of the power-law sensitivity study carried out in Phase 2.

It uses a power-law material gradient with exponent n = 5 and a refined discretization of the enthesis region with 16 layers.
...
This model is used to evaluate the effect of a high power-law exponent on stress distribution.

## Expected Behavior

Compared to lower exponents, the n = 5 configuration is expected to:

* delay stiffness increase significantly across the interface
* produce a very gradual transition
* potentially reduce peak stress but spread it over a larger region
